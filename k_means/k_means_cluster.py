...
max_stok_index = max(stock, key=lambda x: stock[x]['salary'])
min_stok_index = min(stock, key=lambda x: stock[x]['salary'])
print "Max:", stock[max_stok_index]['salary']
print "Min:", stock[min_stok_index]['salary']
...
#numpy.vstack((finance_features, [[200000.0, 1000000.0]]))
#import pprint
...
#numpy.append(finance_features.append,[200000.0, 1000000.0])
#print "================================"
#pprint.pprint(finance_features)
